...
cars_on_order = {
    ...
    # Основной список автомобилей
        ...
        'description': 'Subaru XV 2022 года в отличном состоянии. Полный привод 4WD, без пробега по РФ. Полностью обслужен, готов к эксплуатации.'
